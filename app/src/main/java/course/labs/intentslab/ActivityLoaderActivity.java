...
public class ActivityLoaderActivity extends Activity {
	...
	static private final String URL = "http://google.com.br";
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		// Process the result only if this method received both a RESULT_OK result code and a recognized request code
		if( (resultCode == Activity.RESULT_OK && requestCode == GET_TEXT_REQUEST_CODE) ){

            // If so, update the Textview showing the user-entered text
            Log.i(TAG, "Entered onActivityResult() e passou pele Activity OK");
            mUserTextView.setText(data.getStringExtra("conteudoEditTextExplicity"));
		}
    }
}